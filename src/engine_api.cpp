...
*
* Example:
* Setting g_EngineFunctionsTable_Post.pfnServerExecute to a function
* will caused it to be called "POST", i.e., after the engine calls pfnServerExecute.
*
* This are not needed right now, they are here for example sake.
*/
...
C_DLLEXPORT int GetEngineFunctions(enginefuncs_t *pengfuncsFromEngine, int *interfaceVersion)
{
	if (!pengfuncsFromEngine) {
		LOG_CONSOLE(PLID, "%s called with null pengfuncsFromEngine", __FUNCTION__);
		return FALSE;
	}

	if (*interfaceVersion != ENGINE_INTERFACE_VERSION) {
		LOG_CONSOLE(PLID, "%s version mismatch; Expected: %d; Found: %d", __FUNCTION__, *interfaceVersion, ENGINE_INTERFACE_VERSION);
